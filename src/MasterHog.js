    ...
    return (
      <div>
        ...
        <ul className="hoglist">
          <BabyHog eyeColor = {this.state.eyeColor} hog = {offspring[0]}/>
          <BabyHog eyeColor = {this.state.eyeColor} hog = {offspring[1]}/>
          <BabyHog eyeColor = {this.state.eyeColor} hog = {offspring[2]}/>
        </ul>
